...
if __name__ == "__main__":
    ...
    model = MRINet(num_classes=2).to(device)

    # Print model summary (ensure correct input shape is passed and the device is correct)
    print(torchsummary.summary(model, (1, 224, 224, 224), device=str(device)))
